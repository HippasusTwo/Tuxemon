...
# Copyright (c) 2014-2024 HippasusTwo, William Edwards <shadowapex@gmail.com>, Benjamin Bean <superman2k5@gmail.com>
...
@final
@dataclass
class TeleportToPlayerAction(EventAction):
    """
    Put NPC by Player.
    ...
    Script usage:
        .. code-block::
            ...
            teleport_to_player <npc_slug>,[direction],[distance]

    Script parameters:
        npc_slug: Npc slug name (e.g. "starter").
